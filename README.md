...
[เกี่ยวกับโปรเจกต์](#-เกี่ยวกับโปรเจกต์-about-the-project) • [ฟีเจอร์เด่น](#-ฟีเจอร์หลัก-key-features) • [โครงสร้างโปรเจกต์](#-โครงสร้างโปรเจกต์-project-architecture) • [การติดตั้งและรัน](#-การติดตั้งและเริ่มต้นใช้งาน-getting-started) • [การสร้างไฟล์ติดตั้ง](#-การสร้างไฟล์สำหรับติดตั้งบนอุปกรณ์-building--installing) • [การทดสอบ](#-การทดสอบระบบ-testing)
...
**Manga Collection** คือแอปพลิเคชันสำหรับนักสะสมหนังสือการ์ตูนและมังงะ ที่ออกแบบมาเพื่อแก้ปัญหาคลาสสิกของนักอ่านตัวจริง:
* ❓ **จำไม่ได้ว่าซื้อถึงเล่มไหน:** โดยเฉพาะเวลายืนเลือกซื้อหนังสือหน้าร้านหรือในงานหนังสือ
* 💸 **ซื้อเล่มซ้ำซ้อน:** ป้องกันการเผลอซื้อเล่มเดิมซ้ำ เสียเงินและเสียพื้นที่จัดเก็บโดยใช่เหตุ
* 🔍 **เช็กเล่มที่ขาดได้ยาก:** มีระบบตัวกรองพิเศษเพื่อแยกมังงะที่ยังสะสมไม่ครบออกมาโดยเฉพาะ
* 📉 **ขาดการสรุปภาพรวม:** ระบบ Dashboard จะคำนวณจำนวนเล่มและเปอร์เซ็นต์ความสมบูรณ์ของทั้งคลังให้แบบเรียลไทม์

### 💡 จุดเด่นและปรัชญาการออกแบบ (Design Philosophy):
1. **ทำงานแบบออฟไลน์ 100% (Offline-First & Privacy):**  
   ไม่ต้องสมัครสมาชิก ไม่ต้องต่อเน็ต และไม่เก็บข้อมูลผู้ใช้ไว้บนคลาวด์ ข้อมูลและภาพปกทั้งหมดจะถูกบันทึกไว้ในเครื่องของคุณอย่างปลอดภัย
2. **สถาปัตยกรรมลีนและเบา (Lean & Clean Codebase):**  
   ผ่านการ Refactor ตามหลัก **Ponytail (Lazy Senior Dev)** ปราศจาก Dependency ที่ไม่จำเป็น ใช้ Pure Dart Data Models ทำให้ตัวแอปเปิดเร็ว ลื่นไหล และประหยัดพลังงานแบตเตอรี่
3. **จัดเก็บภาพปกถาวร (Persistent Local Storage):**  
   ระบบจะคัดลอกรูปภาพหน้าปกไปยัง Documents Directory ของแอปอย่างถาวร รูปภาพจะไม่สูญหายแม้ระบบปฏิบัติการจะทำการล้างแคชเครื่อง
4. **ความยืดหยุ่นในการใช้งาน (Seamless UX):**  
   มีทั้งระบบ Stepper ปรับทีละเล่ม, พิมพ์ตัวเลขระบุจำนวนเล่มทั้งหมด, ปุ่มเลือก/ยกเลิกทั้งหมด และเมนูกดค้าง (Long Press) จัดการมังงะได้ทันใจจากหน้าคลัง
